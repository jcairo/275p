#!/usr/bin/python
"""
Copied wgeditmultiline.py
Added Functions: h_undo_state, h_redo_stat, save_state
...
class EmailComposeWidget(widget.Widget):
    ...
    def set_up_handlers(self):
        super(EmailComposeWidget, self).set_up_handlers()    
