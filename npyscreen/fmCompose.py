...
class ActionFormCompose(fmForm.Form):
    ...
    def set_up_exit_condition_handlers(self):
        super(ActionFormCompose, self).set_up_exit_condition_handlers()
    ...
    def move_ok_button(self):
        super(ActionFormCompose, self).move_ok_button()
...
class ActionFormExpanded(ActionFormCompose):
    BLANK_LINES_BASE   = 1
