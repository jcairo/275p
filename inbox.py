...
class Inbox(npyscreen.FormBaseNew):
    def create(self):
        ...
        def mark_read_button(*args):
            ...
            if rv == 'OK':
                self.parentApp.mail.inbox_messages[selected_msg_index].unread = False
    ...
    def new_mail(self, *args):
        ...
        self.parentApp.mail.email_hdr_lst.insert(0, fmt_msg_hdr)
        self.msg_headers.values = self.parentApp.mail.email_hdr_lst
        self.parentApp.mail.inbox_messages.insert(0, new_msg)
